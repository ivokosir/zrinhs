...
operatonTypes Equal = (TInt, TInt, TBool)
operatonTypes NotEqual = (TInt, TInt, TBool)
operatonTypes Greater = (TInt, TInt, TBool)
operatonTypes GreaterEqual = (TInt, TInt, TBool)
operatonTypes Less = (TInt, TInt, TBool)
operatonTypes LessEqual = (TInt, TInt, TBool)
